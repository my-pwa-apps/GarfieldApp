(function() {
    // Define patterns only once
    const successfulUrlPatterns = [
        // ...existing patterns...
    ];
    ...
    window.PreviousClick = async function() {
    ...
    window.NextClick = async function() {
        if(document.getElementById("showfavs").checked) {
            var favs = JSON.parse(localStorage.getItem('favs'));
    ...
    window.RandomClick = async function() {
        if(document.getElementById("showfavs").checked) {
            var favs = JSON.parse(localStorage.getItem('favs'));
    ...
    window.FirstClick = async function() {
        if(document.getElementById("showfavs").checked) {
            var favs = JSON.parse(localStorage.getItem('favs'));
    ...
    window.CurrentClick = async function() {
        if(document.getElementById("showfavs").checked) {
            var favs = JSON.parse(localStorage.getItem('favs'));
    ...
    window.DateChange = async function() {
    ...
    // Private helper functions and other code here
    ...
    (function() {
        ...
        // Make onLoad available globally
        window.onLoad = async function() {
            if (document.getElementById('lastdate').checked) {
                const savedDate = localStorage.getItem('lastDate');
                if (savedDate) {
