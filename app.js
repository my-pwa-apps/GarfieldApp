...
document.addEventListener('DOMContentLoaded', () => {
    document.getElementById('Previous').addEventListener('click', () => handlers.PreviousClick());
    document.getElementById('Next').addEventListener('click', () => handlers.NextClick());
    document.getElementById('Random').addEventListener('click', () => handlers.RandomClick());
    document.getElementById('First').addEventListener('click', () => handlers.FirstClick());
    document.getElementById('Today').addEventListener('click', () => handlers.CurrentClick());
    document.getElementById('DatePicker').addEventListener('input', () => handlers.DateChange());
    document.getElementById('comic').addEventListener('click', () => handlers.Rotate());
    // ...other event listeners...

    handlers.onLoad().catch(console.error);
});
